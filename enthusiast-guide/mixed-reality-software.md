...
1. **Portal de realidad mixta**, que proporciona la experiencia principal de Windows Mixed Reality
    * En Windows 10, versiones 1709 y 1803, el portal de realidad mixta es un componente clave del sistema operativo Windows 10 y se actualiza a través de Windows Update.
    * En Windows 10, la versión 1809 y versiones más recientes, el portal de realidad mixta se actualiza a través de la aplicación Microsoft Store.
...
4. Los **controladores de modelo de controlador de movimiento de realidad mixta** contienen los modelos 3D de los controladores de movimiento de realidad mixta y son necesarios para experiencias de realidad mixta de terceros. Esto se descarga e instala automáticamente a través de Windows Update la primera vez que los controladores de movimiento de realidad mixta se emparejan con el equipo y se actualizan a través de Windows Update
...
Además, el uso de Windows Mixed Reality en SteamVR requiere el siguiente software:
...
* Cambia el comportamiento de la configuración de frecuencia de actualización de 90Hz en Windows Mixed Reality a no volver a cambiar automáticamente a 60Hz en ciertos casos en los que no se puede lograr 90Hz. 
...
#### <a name="windows-10-version-1903-may-2019-update"></a>Windows 10, versión 1903 (actualización de mayo de 2019) ####
   ...
   | [10.0.18362.1024](https://www.microsoft.com/en-us/download/details.aspx?id=58225)  | 1 de mayo de 2019      | Compatible con Windows 10, la versión 1809 y versiones más recientes.<br/><ul><li>Contiene la actualización de firmware para 2017 Acer, ASUS, Dell, Fujitsu, HP, Lenovo y Medion con auriculares con Windows Mixed Reality. Esta actualización de firmware mejora la compatibilidad y la confiabilidad de la pantalla con ciertos adaptadores de gráficos y controladores de gráficos.</li><li>Mejoras en la confiabilidad y la plataforma con auriculares de realidad mixta de Windows</li></ul>  | 
...
#### <a name="windows-10-version-1809-and-newer"></a>Windows 10, versión 1809 y versiones más recientes ####
   ...
   | 2000.20031.1202.0  | 14 de abril de 2020        | <ul><li>Soporte para registrarse para obtener información, sugerencias y ofertas sobre Windows Mixed Reality.</li></ul>  | 
   ...
   | 2000.19081.1301.0  | 23 de septiembre de 2019    | <ul><li>Soluciona un problema en el que se muestra un mensaje de error incorrecto en los auriculares que detectan problemas de hardware. Los usuarios que recibieron un código de error 1-4 en versiones anteriores ahora pueden recibir un código de error más específico para su estado de dispositivo.</li></ul>  |
