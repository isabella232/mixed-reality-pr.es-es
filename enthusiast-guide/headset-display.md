...
* Compruebe el rendimiento y la estabilidad del equipo:
    ...
    * Compruebe los registros "aplicación" y "sistema" en **Visor de eventos > registros de Windows** para ver si tiene una aplicación que se bloquea con frecuencia y genera informes informe de errores de Windows (WER).
...
* Comprobar la compatibilidad de tarjetas y controladores de gráficos:
    ...
    * Si usa un libro de superficie 2, asegúrese de que está usando el [adaptador de USB-C de la superficie de Surface](https://docs.microsoft.com/windows/mixed-reality/enthusiast-guide/recommended-adapters-for-windows-mixed-reality-capable-pcs).
...
Esta información también se muestra en un [Diagrama de flujo de solución de problemas](headset-display-chart.md).
...
* Conecte un concentrador USB 3,0 con tecnología externa a su PC y conecte los auriculares a la central.
...
Es posible que el sistema no pueda presentar contenido al casco o que el sistema de seguimiento esté experimentando problemas. Compruebe lo siguiente:
