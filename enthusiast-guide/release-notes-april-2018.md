...
* **Otras mejoras** : la configuración de rendimiento automática se ha actualizado para proporcionar una experiencia más optimizada (puede [invalidar](#visual-quality) esta configuración manualmente). Ahora, el programa de instalación proporciona información más detallada acerca de los problemas de compatibilidad comunes con tarjetas gráficas y controladores USB 3,0.
