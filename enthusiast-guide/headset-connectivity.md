...
- Asegúrese de que los cables USB y HDMI y/o DisplayPort del auricular están conectados a los puertos correctos del equipo. Aquí se describe cómo identificar los puertos correctos:
...
- Si ve una enumeración parcial de los auriculares (una serie de dispositivos USB enumeración, pero no hay nada en "auriculares de realidad mixta" en Device Manager), pruebe un concentrador USB 3,0 de alimentación externa.
