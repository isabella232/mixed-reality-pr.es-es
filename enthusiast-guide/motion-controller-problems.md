...
Si los [controladores de movimiento](controllers-in-wmr.md) no funcionan, no se está conectando o si no ve una imagen de los controladores cuando tiene el casco, intente lo siguiente:
