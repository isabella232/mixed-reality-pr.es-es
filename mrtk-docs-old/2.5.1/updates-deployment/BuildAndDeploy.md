...
- [Compatibilidad con Android y iOS](../features/cross-platform/UsingARFoundation.md)
- [Compatibilidad con el movimiento Leap](../features/cross-platform/LeapMotionMRTK.md)
- [Detección de las capacidades de la plataforma](../features/cross-platform/DetectingPlatformCapabilities.md)
