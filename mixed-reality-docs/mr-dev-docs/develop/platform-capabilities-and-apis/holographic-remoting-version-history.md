...
* Holographic Remoting Player on Desktop (Reproductor de comunicación remota holográfica en el escritorio): muestra un mensaje de error cuando Windows Mixed Reality no está instalado en lugar de cerrarse en modo silencioso.
...
* Se ha corregido un bloqueo al llamar a [HolographicCameraRenderingParameters.CommitDirect3D11DepthBuffer](/uwp/api/windows.graphics.holographic.holographiccamerarenderingparameters.commitdirect3d11depthbuffer) con [IDXGISurface2 como](/windows/win32/api/dxgi1_2/nn-dxgi1_2-idxgisurface2) parámetro.
* Mejoras de estabilidad y confiabilidad
