...
description: Obtenga información sobre cómo transmitir contenido remoto representado en un equipo remoto para HoloLens 2 aplicaciones de comunicación remota holográfica con HolographicSpace.
...
>[!NOTE]
>La **versión 1.x.x** del paquete NuGet está disponible para los desarrolladores que desean tener como destino HoloLens 1. Para más información, consulte Agregar comunicación remota holográfica [(HoloLens (1.ª generación)).](add-holographic-remoting.md)
...
A continuación, es necesario crear el espacio holográfico. No es necesario especificar corewindow. Las aplicaciones de escritorio que no tienen coreWindow solo pueden pasar un ```nullptr``` .
...
Para establecer una conexión desde la aplicación remota al dispositivo del reproductor, llame al método en el contexto remoto especificando el ```Connect``` nombre de host y el puerto. El puerto que usa holographic remoting Player es **8265.**
