...
description: Las aplicaciones holográficas pueden compartir delimitadores espaciales de una HoloLens a otra, lo que permite a los usuarios representar un holograma en el mismo lugar del mundo real, en varios dispositivos.
author: thetuvix
ms.author: grbury
ms.date: 02/10/2019
ms.topic: article
...
Hay muchas maneras de compartir, pero hemos descubierto que la mayoría de ellas se encuentran en tres categorías:
...
* **De forma asincrónica:** uso compartido de la experiencia holográfica en momentos diferentes. Por ejemplo: dos alumnos realizando el laboratorio de aptitudes pero trabajando en secciones independientes en momentos diferentes.
...
* **Similar:** entornos que tienden a tener un ambiente similar, luz ambiental y sonido, tamaño de la sala física. Por ejemplo: el profesor está en el aula A y los alumnos están en el aula B. El aula A podría tener menos alumnos que B, pero ambos pueden tener un escritorio físico en el que colocar hologramas.
...
* **Uso compartido de** delimitadores: capacidad de alinear coordenadas entre varios dispositivos en un espacio local común, por lo que los hologramas aparecen en el mismo lugar para todas las personas.
...
La clave de las experiencias compartidas es que varios usuarios vean los mismos hologramas del mundo en su propio dispositivo, lo que suele hacerse mediante el uso compartido de anclajes para alinear las coordenadas entre los dispositivos.

Para compartir delimitadores, use [el](/azure/spatial-anchors)Spatial Anchors Azure :

* En primer lugar, el usuario coloca el holograma.
* La aplicación crea [un delimitador espacial](../../design/spatial-anchors.md)para anclar ese holograma con precisión en el mundo.
...
Las interfaces y las funcionalidades de los componentes ayudarán a proporcionar una coherencia común y una sólida compatibilidad en los distintos escenarios y tecnologías subyacentes.  Hasta entonces, elija la mejor ruta de acceso que se adapte al escenario que está intentando lograr en la aplicación.
