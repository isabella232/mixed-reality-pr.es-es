...
## <a name="before-you-start"></a><span data-ttu-id="d5c24-152">Antes de comenzar</span><span class="sxs-lookup"><span data-stu-id="d5c24-152">Before you start</span></span>
...
3.  <span data-ttu-id="d5c24-163">Inicie sesión en el portal de Custom Vision.</span><span class="sxs-lookup"><span data-stu-id="d5c24-163">Sign in to the Custom Vision Portal.</span></span>
...
7. <span data-ttu-id="d5c24-235">En este panel, deben comprobarse algunas opciones de configuración:</span><span class="sxs-lookup"><span data-stu-id="d5c24-235">In this panel, a few settings need to be verified:</span></span>
    ...
    1.  <span data-ttu-id="d5c24-236">En la pestaña **otros valores** :</span><span class="sxs-lookup"><span data-stu-id="d5c24-236">In the **Other Settings** tab:</span></span>
        ...
        3. <span data-ttu-id="d5c24-239">El **nivel de compatibilidad de API** debe ser **.net 4,6** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-239">**API Compatibility Level** should be **.NET 4.6** .</span></span>
...
<span data-ttu-id="d5c24-290">Para crear esta clase:</span><span class="sxs-lookup"><span data-stu-id="d5c24-290">To create this class:</span></span>
...
## <a name="chapter-6---create-the-customvisionobjects-class"></a><span data-ttu-id="d5c24-308">Capítulo 6: crear la clase CustomVisionObjects</span><span class="sxs-lookup"><span data-stu-id="d5c24-308">Chapter 6 - Create the CustomVisionObjects class</span></span>
...
4.  <span data-ttu-id="d5c24-329">A continuación, agregue las siguientes variables dentro de la clase **SpatialMapping** , sobre el método **Start ()** :</span><span class="sxs-lookup"><span data-stu-id="d5c24-329">Then, add the following variables inside the **SpatialMapping** class, above the **Start()** method:</span></span>
...
6.  <span data-ttu-id="d5c24-331">Elimine el método **Update ()** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-331">Delete the **Update()** method.</span></span>
...
7. <span data-ttu-id="d5c24-344">Asegúrese de guardar los cambios en **Visual Studio** antes de volver a **Unity** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-344">Be sure to save your changes in **Visual Studio** , before returning to **Unity** .</span></span>
...
8.  <span data-ttu-id="d5c24-360">Agregue el método **FinaliseLabel ()** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-360">Add the **FinaliseLabel()** method.</span></span> <span data-ttu-id="d5c24-361">Es el responsable de:</span><span class="sxs-lookup"><span data-stu-id="d5c24-361">It is responsible for:</span></span>
...
## <a name="chapter-10---create-the-imagecapture-class"></a><span data-ttu-id="d5c24-370">Capítulo 10: creación de la clase ImageCapture</span><span class="sxs-lookup"><span data-stu-id="d5c24-370">Chapter 10 - Create the ImageCapture class</span></span>

<span data-ttu-id="d5c24-371">La clase siguiente que va a crear es la clase **ImageCapture** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-371">The next class you are going to create is the **ImageCapture** class.</span></span>

<span data-ttu-id="d5c24-372">Esta clase es responsable de:</span><span class="sxs-lookup"><span data-stu-id="d5c24-372">This class is responsible for:</span></span>

*   <span data-ttu-id="d5c24-373">Captura de una imagen con la cámara de HoloLens y su almacenamiento en la carpeta de la *aplicación* .</span><span class="sxs-lookup"><span data-stu-id="d5c24-373">Capturing an image using the HoloLens camera and storing it in the *App* folder.</span></span>
*   <span data-ttu-id="d5c24-374">Controlar los gestos de *TAP* del usuario.</span><span class="sxs-lookup"><span data-stu-id="d5c24-374">Handling *Tap* gestures from the user.</span></span>

<span data-ttu-id="d5c24-375">Para crear esta clase:</span><span class="sxs-lookup"><span data-stu-id="d5c24-375">To create this class:</span></span>

1.  <span data-ttu-id="d5c24-376">Vaya a la carpeta **scripts** que creó anteriormente.</span><span class="sxs-lookup"><span data-stu-id="d5c24-376">Go to the **Scripts** folder you created previously.</span></span>

2.  <span data-ttu-id="d5c24-377">Haga clic con el botón derecho en la carpeta y luego haga clic en **crear**  >  **\# script de C** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-377">Right-click inside the folder, then click **Create** > **C\# Script** .</span></span> <span data-ttu-id="d5c24-378">Asigne al script el nombre **ImageCapture** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-378">Name the script **ImageCapture** .</span></span>

3.  <span data-ttu-id="d5c24-379">Haga doble clic en el nuevo script **ImageCapture** para abrirlo con **Visual Studio.**</span><span class="sxs-lookup"><span data-stu-id="d5c24-379">Double-click on the new **ImageCapture** script to open it with **Visual Studio.**</span></span>

4.  <span data-ttu-id="d5c24-380">Reemplace los espacios de nombres en la parte superior del archivo por lo siguiente:</span><span class="sxs-lookup"><span data-stu-id="d5c24-380">Replace the namespaces at the top of the file with the following:</span></span>
...
5.  <span data-ttu-id="d5c24-381">A continuación, agregue las siguientes variables dentro de la clase **ImageCapture** , sobre el método **Start ()** :</span><span class="sxs-lookup"><span data-stu-id="d5c24-381">Then add the following variables inside the **ImageCapture** class, above the **Start()** method:</span></span>
...
6.  <span data-ttu-id="d5c24-382">Ahora es necesario agregar el código para los métodos **activo ()** e **Inicio ()** :</span><span class="sxs-lookup"><span data-stu-id="d5c24-382">Code for **Awake()** and **Start()** methods now needs to be added:</span></span>
...
7.  <span data-ttu-id="d5c24-383">Implemente un controlador que se llamará cuando se produzca un gesto de punteo:</span><span class="sxs-lookup"><span data-stu-id="d5c24-383">Implement a handler that will be called when a Tap gesture occurs:</span></span>
    ...
    > [!IMPORTANT]
    > <span data-ttu-id="d5c24-384">Cuando el cursor está en **verde** , significa que la cámara está disponible para tomar la imagen.</span><span class="sxs-lookup"><span data-stu-id="d5c24-384">When the cursor is **green** , it means the camera is available to take the image.</span></span> <span data-ttu-id="d5c24-385">Cuando el cursor está en **rojo** , significa que la cámara está ocupada.</span><span class="sxs-lookup"><span data-stu-id="d5c24-385">When the cursor is **red** , it means the camera is busy.</span></span>

8.  <span data-ttu-id="d5c24-386">Agregue el método que usa la aplicación para iniciar el proceso de captura de imagen y almacenar la imagen:</span><span class="sxs-lookup"><span data-stu-id="d5c24-386">Add the method that the application uses to start the image capture process and store the image:</span></span>
...
9.  <span data-ttu-id="d5c24-387">Agregue los controladores a los que se llamará cuando se haya capturado la foto y cuando esté listo para su análisis.</span><span class="sxs-lookup"><span data-stu-id="d5c24-387">Add the handlers that will be called when the photo has been captured and for when it is ready to be analyzed.</span></span> <span data-ttu-id="d5c24-388">A continuación, el resultado se pasa a **CustomVisionAnalyser** para su análisis.</span><span class="sxs-lookup"><span data-stu-id="d5c24-388">The result is then passed to the **CustomVisionAnalyser** for analysis.</span></span>
...
10. <span data-ttu-id="d5c24-389">Asegúrese de guardar los cambios en **Visual Studio** antes de volver a **Unity** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-389">Be sure to save your changes in **Visual Studio** , before returning to **Unity** .</span></span>

## <a name="chapter-11---setting-up-the-scripts-in-the-scene"></a><span data-ttu-id="d5c24-390">Capítulo 11: configuración de los scripts de la escena</span><span class="sxs-lookup"><span data-stu-id="d5c24-390">Chapter 11 - Setting up the scripts in the scene</span></span>

<span data-ttu-id="d5c24-391">Ahora que ha escrito todo el código necesario para este proyecto, es el momento de configurar los scripts en la escena y en Prefabs para que se comporten correctamente.</span><span class="sxs-lookup"><span data-stu-id="d5c24-391">Now that you have written all of the code necessary for this project, is time to set up the scripts in the scene, and on the prefabs, for them to behave correctly.</span></span>

1.  <span data-ttu-id="d5c24-392">Dentro del **Editor de Unity** , en el **Panel jerarquía** , seleccione la **cámara principal** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-392">Within the **Unity Editor** , in the **Hierarchy Panel** , select the **Main Camera** .</span></span>
2.  <span data-ttu-id="d5c24-393">En el **panel Inspector** , con la **cámara principal** seleccionada, haga clic en **Agregar componente** , busque el script **SceneOrganiser** y haga doble clic en, para agregarlo.</span><span class="sxs-lookup"><span data-stu-id="d5c24-393">In the **Inspector Panel** , with the **Main Camera** selected, click on **Add Component** , then search for **SceneOrganiser** script and double-click, to add it.</span></span>

    ![](images/AzureLabs-Lab310-38.png)

3.  <span data-ttu-id="d5c24-394">En el **panel Proyecto** , abra la **carpeta Prefabs** , arrastre la **etiqueta** recurso prefabricado al área de entrada de destino de referencia vacía de *etiqueta* , en el script **SceneOrganiser** que acaba de agregar a la *cámara principal* , como se muestra en la imagen siguiente:</span><span class="sxs-lookup"><span data-stu-id="d5c24-394">In the **Project Panel** , open the **Prefabs folder** , drag the **Label** prefab into the *Label* empty reference target input area, in the **SceneOrganiser** script that you have just added to the *Main Camera* , as shown in the image below:</span></span>

    ![](images/AzureLabs-Lab310-39.png)

4.  <span data-ttu-id="d5c24-395">En el **Panel jerarquía** , seleccione el elemento secundario **GazeCursor** de la **cámara principal** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-395">In the **Hierarchy Panel** , select the **GazeCursor** child of the **Main Camera** .</span></span>
5.  <span data-ttu-id="d5c24-396">En el **panel Inspector** , con la **GazeCursor** seleccionada, haga clic en **Agregar componente** , busque el script **GazeCursor** y haga doble clic en para agregarlo.</span><span class="sxs-lookup"><span data-stu-id="d5c24-396">In the **Inspector Panel** , with the **GazeCursor** selected, click on **Add Component** , then search for **GazeCursor** script and double-click, to add it.</span></span>

    ![](images/AzureLabs-Lab310-40.png)

6.  <span data-ttu-id="d5c24-397">De nuevo, en el **Panel jerarquía** , seleccione el elemento secundario **SpatialMapping** de la **cámara principal** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-397">Again, in the **Hierarchy Panel** , select the **SpatialMapping** child of the **Main Camera** .</span></span>
7.  <span data-ttu-id="d5c24-398">En el **panel Inspector** , con la **SpatialMapping** seleccionada, haga clic en **Agregar componente** , busque el script **SpatialMapping** y haga doble clic en para agregarlo.</span><span class="sxs-lookup"><span data-stu-id="d5c24-398">In the **Inspector Panel** , with the **SpatialMapping** selected, click on **Add Component** , then search for **SpatialMapping** script and double-click, to add it.</span></span>

    ![](images/AzureLabs-Lab310-41.png)

<span data-ttu-id="d5c24-399">Los scripts restantes que no haya establecido se agregarán mediante el código del script **SceneOrganiser** , durante el tiempo de ejecución.</span><span class="sxs-lookup"><span data-stu-id="d5c24-399">The remaining scripts thats you have not set will be added by the code in the **SceneOrganiser** script, during runtime.</span></span>

## <a name="chapter-12---before-building"></a><span data-ttu-id="d5c24-400">Capítulo 12: antes de la compilación</span><span class="sxs-lookup"><span data-stu-id="d5c24-400">Chapter 12 - Before building</span></span>

<span data-ttu-id="d5c24-401">Para realizar una prueba exhaustiva de la aplicación, debe transferirla a Microsoft HoloLens.</span><span class="sxs-lookup"><span data-stu-id="d5c24-401">To perform a thorough test of your application you will need to sideload it onto your Microsoft HoloLens.</span></span>

<span data-ttu-id="d5c24-402">Antes de hacerlo, asegúrese de que:</span><span class="sxs-lookup"><span data-stu-id="d5c24-402">Before you do, ensure that:</span></span>

-  <span data-ttu-id="d5c24-403">Toda la configuración mencionada en el [capítulo 3](#chapter-3---set-up-the-unity-project) se establece correctamente.</span><span class="sxs-lookup"><span data-stu-id="d5c24-403">All the settings mentioned in the [Chapter 3](#chapter-3---set-up-the-unity-project) are set correctly.</span></span>
- <span data-ttu-id="d5c24-404">El script **SceneOrganiser** se adjunta al objeto de **cámara principal** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-404">The script **SceneOrganiser** is attached to the **Main Camera** object.</span></span>
- <span data-ttu-id="d5c24-405">El script **GazeCursor** se adjunta al objeto **GazeCursor** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-405">The script **GazeCursor** is attached to the **GazeCursor** object.</span></span>
- <span data-ttu-id="d5c24-406">El script **SpatialMapping** se adjunta al objeto **SpatialMapping** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-406">The script **SpatialMapping** is attached to the **SpatialMapping** object.</span></span>
- <span data-ttu-id="d5c24-407">En el [capítulo 5](#chapter-5---create-the-customvisionanalyser-class), paso 6:</span><span class="sxs-lookup"><span data-stu-id="d5c24-407">In [Chapter 5](#chapter-5---create-the-customvisionanalyser-class), Step 6:</span></span>

    - <span data-ttu-id="d5c24-408">Asegúrese de insertar la **clave de predicción de servicio** en la variable **predictionKey** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-408">Make sure you insert your **Service Prediction Key** into the **predictionKey** variable.</span></span>
    - <span data-ttu-id="d5c24-409">Ha insertado el **punto de conexión de predicción** en la clase **predictionEndpoint** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-409">You have inserted your **Prediction Endpoint** into the **predictionEndpoint** class.</span></span>

## <a name="chapter-13---build-the-uwp-solution-and-sideload-your-application"></a><span data-ttu-id="d5c24-410">Capítulo 13: compilar la solución UWP y transferir localmente la aplicación</span><span class="sxs-lookup"><span data-stu-id="d5c24-410">Chapter 13 - Build the UWP solution and sideload your application</span></span>

<span data-ttu-id="d5c24-411">Ya está listo para compilar la aplicación como una solución de UWP en la que podrá realizar la implementación en Microsoft HoloLens.</span><span class="sxs-lookup"><span data-stu-id="d5c24-411">You are now ready to build you application as a UWP Solution that you will be able to deploy on to the Microsoft HoloLens.</span></span> <span data-ttu-id="d5c24-412">Para comenzar el proceso de compilación:</span><span class="sxs-lookup"><span data-stu-id="d5c24-412">To begin the build process:</span></span>

1.  <span data-ttu-id="d5c24-413">Vaya a **archivo > configuración de compilación** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-413">Go to **File > Build Settings** .</span></span>

2.  <span data-ttu-id="d5c24-414">Marque **\# proyectos de Unity C** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-414">Tick **Unity C\# Projects** .</span></span>

3.  <span data-ttu-id="d5c24-415">Haga clic en **Agregar escenas abiertas** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-415">Click on **Add Open Scenes** .</span></span> <span data-ttu-id="d5c24-416">Esto agregará la escena abierta actualmente a la compilación.</span><span class="sxs-lookup"><span data-stu-id="d5c24-416">This will add the currently open scene to the build.</span></span>

    ![](images/AzureLabs-Lab310-42.png)

4.  <span data-ttu-id="d5c24-417">Haga clic en **Generar** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-417">Click **Build** .</span></span> <span data-ttu-id="d5c24-418">Unity iniciará una ventana del *Explorador de archivos* , donde tendrá que crear y seleccionar una carpeta en la que compilar la aplicación.</span><span class="sxs-lookup"><span data-stu-id="d5c24-418">Unity will launch a *File Explorer* window, where you need to create and then select a folder to build the app into.</span></span> <span data-ttu-id="d5c24-419">Cree esa carpeta ahora y asígnele el nombre **App** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-419">Create that folder now, and name it **App** .</span></span> <span data-ttu-id="d5c24-420">Después, con la carpeta de la **aplicación** seleccionada, haga clic en **Seleccionar carpeta** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-420">Then with the **App** folder selected, click **Select Folder** .</span></span>

5.  <span data-ttu-id="d5c24-421">Unity comenzará a compilar el proyecto en la carpeta de la **aplicación** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-421">Unity will begin building your project to the **App** folder.</span></span>

6.  <span data-ttu-id="d5c24-422">Una vez que Unity termine de compilar (puede tardar algún tiempo), se abrirá una ventana del **Explorador de archivos** en la ubicación de la compilación (Compruebe la barra de tareas, ya que es posible que no aparezca siempre por encima de las ventanas, pero le notificará la adición de una nueva ventana).</span><span class="sxs-lookup"><span data-stu-id="d5c24-422">Once Unity has finished building (it might take some time), it will open a **File Explorer** window at the location of your build (check your task bar, as it may not always appear above your windows, but will notify you of the addition of a new window).</span></span>

7.  <span data-ttu-id="d5c24-423">Para realizar la implementación en Microsoft HoloLens, necesitará la dirección IP de ese dispositivo (para la implementación remota) y para asegurarse de que también tiene establecido el **modo de desarrollador** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-423">To deploy on to Microsoft HoloLens, you will need the IP Address of that device (for Remote Deploy), and to ensure that it also has **Developer Mode** set.</span></span> <span data-ttu-id="d5c24-424">Para ello, siga estos pasos:</span><span class="sxs-lookup"><span data-stu-id="d5c24-424">To do this:</span></span>

    1.  <span data-ttu-id="d5c24-425">Mientras se contenga HoloLens, abra la **configuración** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-425">Whilst wearing your HoloLens, open the **Settings** .</span></span>

    2.  <span data-ttu-id="d5c24-426">Vaya a **red &**  >  Opciones avanzadas **de Wi-Fi de**  >  **Advanced Options** Internet</span><span class="sxs-lookup"><span data-stu-id="d5c24-426">Go to **Network & Internet** > **Wi-Fi** > **Advanced Options**</span></span>

    3.  <span data-ttu-id="d5c24-427">Anote la dirección **IPv4** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-427">Note the **IPv4** address.</span></span>

    4.  <span data-ttu-id="d5c24-428">A continuación, vuelva a **configuración** y, a continuación, **actualice & Security**  >  **para desarrolladores**</span><span class="sxs-lookup"><span data-stu-id="d5c24-428">Next, navigate back to **Settings** , and then to **Update & Security** > **For Developers**</span></span>

    5.  <span data-ttu-id="d5c24-429">Establezca el **modo de desarrollador** *en* .</span><span class="sxs-lookup"><span data-stu-id="d5c24-429">Set **Developer Mode** *On* .</span></span>

8.  <span data-ttu-id="d5c24-430">Vaya a la nueva compilación de Unity (la carpeta de la **aplicación** ) y abra el archivo de solución con **Visual Studio** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-430">Navigate to your new Unity build (the **App** folder) and open the solution file with **Visual Studio** .</span></span>

9.  <span data-ttu-id="d5c24-431">En la configuración de soluciones, seleccione **depurar** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-431">In the Solution Configuration select **Debug** .</span></span>

10. <span data-ttu-id="d5c24-432">En la plataforma de la solución, seleccione **x86, equipo remoto** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-432">In the Solution Platform, select **x86, Remote Machine** .</span></span> <span data-ttu-id="d5c24-433">Se le pedirá que inserte la **dirección IP** de un dispositivo remoto (Microsoft HoloLens, en este caso, que anotó).</span><span class="sxs-lookup"><span data-stu-id="d5c24-433">You will be prompted to insert the **IP address** of a remote device (the Microsoft HoloLens, in this case, which you noted).</span></span>

    ![](images/AzureLabs-Lab310-43.png)

11. <span data-ttu-id="d5c24-434">Vaya al menú **compilar** y haga clic en **implementar solución** para transferir localmente la aplicación a HoloLens.</span><span class="sxs-lookup"><span data-stu-id="d5c24-434">Go to the **Build** menu and click on **Deploy Solution** to sideload the application to your HoloLens.</span></span>

12. <span data-ttu-id="d5c24-435">La aplicación debe aparecer ahora en la lista de aplicaciones instaladas en Microsoft HoloLens, lista para su lanzamiento.</span><span class="sxs-lookup"><span data-stu-id="d5c24-435">Your app should now appear in the list of installed apps on your Microsoft HoloLens, ready to be launched!</span></span>

### <a name="to-use-the-application"></a><span data-ttu-id="d5c24-436">Para usar la aplicación:</span><span class="sxs-lookup"><span data-stu-id="d5c24-436">To use the application:</span></span>

* <span data-ttu-id="d5c24-437">Examine un objeto, que ha entrenado con la Custom Vision Service de **Azure, la detección de objetos** y use el **gesto de TAP** .</span><span class="sxs-lookup"><span data-stu-id="d5c24-437">Look at an object, which you have trained with your **Azure Custom Vision Service, Object Detection** , and use the **Tap gesture** .</span></span>
* <span data-ttu-id="d5c24-438">Si el objeto se detecta correctamente, aparecerá un texto de *etiqueta* de espacio mundial con el nombre de la etiqueta.</span><span class="sxs-lookup"><span data-stu-id="d5c24-438">If the object is successfully detected, a world-space *Label Text* will appear with the tag name.</span></span>

> [!IMPORTANT]
> <span data-ttu-id="d5c24-439">Cada vez que capture una foto y la envíe al servicio, puede volver a la página de servicio y volver a entrenar el servicio con las imágenes recién capturadas.</span><span class="sxs-lookup"><span data-stu-id="d5c24-439">Every time you capture a photo and send it to the Service, you can go back to the Service page and retrain the Service with the newly captured images.</span></span> <span data-ttu-id="d5c24-440">Al principio, probablemente también tendrá que corregir los *cuadros de límite* para ser más precisos y volver a entrenar el servicio.</span><span class="sxs-lookup"><span data-stu-id="d5c24-440">At the beginning, you will probably also have to correct the *Bounding Boxes* to be more accurate and retrain the Service.</span></span>

> [!NOTE]
> <span data-ttu-id="d5c24-441">El texto de la etiqueta que se coloca podría no aparecer cerca del objeto cuando los sensores de Microsoft HoloLens y/o SpatialTrackingComponent en Unity no pueden colocar los colisionadores adecuados, en relación con los objetos reales.</span><span class="sxs-lookup"><span data-stu-id="d5c24-441">The Label Text placed might not appear near the object when the Microsoft HoloLens sensors and/or the SpatialTrackingComponent in Unity fails to place the appropriate colliders, relative to the real world objects.</span></span> <span data-ttu-id="d5c24-442">Si es así, intente usar la aplicación en una superficie diferente.</span><span class="sxs-lookup"><span data-stu-id="d5c24-442">Try to use the application on a different surface if that is the case.</span></span>

## <a name="your-custom-vision-object-detection-application"></a><span data-ttu-id="d5c24-443">La aplicación de detección de objetos de Custom Vision</span><span class="sxs-lookup"><span data-stu-id="d5c24-443">Your Custom Vision, Object Detection application</span></span>

<span data-ttu-id="d5c24-444">Enhorabuena, ha creado una aplicación de realidad mixta que aprovecha el Custom Vision de Azure, la API de detección de objetos, que puede reconocer un objeto de una imagen y, a continuación, proporcionar una posición aproximada para ese objeto en el espacio 3D.</span><span class="sxs-lookup"><span data-stu-id="d5c24-444">Congratulations, you built a mixed reality app that leverages the Azure Custom Vision, Object Detection API, which can recognize an object from an image, and then provide an approximate position for that object in 3D space.</span></span>

![](images/AzureLabs-Lab310-00.png)

## <a name="bonus-exercises"></a><span data-ttu-id="d5c24-445">Ejercicios extra</span><span class="sxs-lookup"><span data-stu-id="d5c24-445">Bonus exercises</span></span>

### <a name="exercise-1"></a><span data-ttu-id="d5c24-446">Ejercicio 1</span><span class="sxs-lookup"><span data-stu-id="d5c24-446">Exercise 1</span></span>

<span data-ttu-id="d5c24-447">Agregando a la etiqueta de texto, use un cubo semitransparente para ajustar el objeto real en un *cuadro de límite* 3D.</span><span class="sxs-lookup"><span data-stu-id="d5c24-447">Adding to the Text Label, use a semi-transparent cube to wrap the real object in a 3D *Bounding Box* .</span></span>

### <a name="exercise-2"></a><span data-ttu-id="d5c24-448">Ejercicio 2</span><span class="sxs-lookup"><span data-stu-id="d5c24-448">Exercise 2</span></span>

<span data-ttu-id="d5c24-449">Entrenar el Custom Vision Service para reconocer más objetos.</span><span class="sxs-lookup"><span data-stu-id="d5c24-449">Train your Custom Vision Service to recognize more objects.</span></span>

### <a name="exercise-3"></a><span data-ttu-id="d5c24-450">Ejercicio 3</span><span class="sxs-lookup"><span data-stu-id="d5c24-450">Exercise 3</span></span>

<span data-ttu-id="d5c24-451">Reproducir un sonido cuando se reconoce un objeto.</span><span class="sxs-lookup"><span data-stu-id="d5c24-451">Play a sound when an object is recognized.</span></span>

### <a name="exercise-4"></a><span data-ttu-id="d5c24-452">Ejercicio 4</span><span class="sxs-lookup"><span data-stu-id="d5c24-452">Exercise 4</span></span>

<span data-ttu-id="d5c24-453">Use la API para volver a entrenar su servicio con las mismas imágenes que está analizando la aplicación, para que el servicio sea más preciso (realice la predicción y el entrenamiento simultáneamente).</span><span class="sxs-lookup"><span data-stu-id="d5c24-453">Use the API to re-train your Service with the same images your app is analyzing, so to make the Service more accurate (do both prediction and training simultaneously).</span></span>
