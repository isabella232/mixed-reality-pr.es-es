...
<span data-ttu-id="1d2bb-124">Este curso le enseñará cómo obtener los resultados de la Custom Vision Service en una aplicación de ejemplo basada en Unity.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-124">This course will teach you how to get the results from the Custom Vision Service into a Unity-based sample application.</span></span> <span data-ttu-id="1d2bb-125">Depende de usted que aplique estos conceptos a una aplicación personalizada que pueda estar compilando.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-125">It will be up to you to apply these concepts to a custom application you might be building.</span></span>
...
## <a name="before-you-start"></a><span data-ttu-id="1d2bb-151">Antes de comenzar</span><span class="sxs-lookup"><span data-stu-id="1d2bb-151">Before you start</span></span>
...
6.  <span data-ttu-id="1d2bb-174">Aparecerá una pestaña en el lado derecho, que le pedirá que especifique algunos campos para el proyecto.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-174">A tab will appear on the right-hand side, which will prompt you to specify some fields for the project.</span></span>
    ...
    4. <span data-ttu-id="1d2bb-180">Establecer los *tipos de proyecto* en **clasificación**</span><span class="sxs-lookup"><span data-stu-id="1d2bb-180">Set the *Project Types* to **Classification**</span></span>
...
9.  <span data-ttu-id="1d2bb-211">Una vez que tenga ambas etiquetas configuradas, haga clic en **entrenar** y la primera iteración de entrenamiento comenzará a compilarse.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-211">Once you have both Tags set up, click on **Train** , and the first training iteration will start building.</span></span>
...
4.  <span data-ttu-id="1d2bb-241">A continuación, vaya a **archivo > configuración de compilación** y seleccione **plataforma universal de Windows** y, después, haga clic en el botón **cambiar plataforma** para aplicar la selección.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-241">Next, go to **File > Build Settings** and select **Universal Windows Platform** , then click on the **Switch Platform** button to apply your selection.</span></span>
    ...
    ![<span data-ttu-id="1d2bb-242">Configurar los valores de compilación</span><span class="sxs-lookup"><span data-stu-id="1d2bb-242">Configure build settings</span></span> ](images/AzureLabs-Lab302b-20.png)
...
5.  <span data-ttu-id="1d2bb-243">Mientras sigue en el **archivo > la configuración de compilación** y asegúrese de que:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-243">While still in **File > Build Settings** and make sure that:</span></span>
    ...
    7.  <span data-ttu-id="1d2bb-260">El resto de la configuración, en la *configuración de compilación* , debe dejarse como predeterminada por ahora.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-260">The remaining settings, in *Build Settings* , should be left as default for now.</span></span>
...
## <a name="chapter-5---camera-setup"></a><span data-ttu-id="1d2bb-302">Capítulo 5: configuración de la cámara</span><span class="sxs-lookup"><span data-stu-id="1d2bb-302">Chapter 5 - Camera setup</span></span>
...
4.  <span data-ttu-id="1d2bb-330">Haga doble clic en el nuevo script *CustomVisionAnalyser* para abrirlo con **Visual Studio** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-330">Double-click on the new *CustomVisionAnalyser* script to open it with **Visual Studio** .</span></span>
...
8.  <span data-ttu-id="1d2bb-336">Elimine los métodos **Start ()** y **Update ()** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-336">Delete the methods **Start()** and **Update()** .</span></span>
...
2.  <span data-ttu-id="1d2bb-349">Haga doble clic en el nuevo script **CustomVisionObjects** para abrirlo con **Visual Studio** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-349">Double-click on the new **CustomVisionObjects** script to open it with **Visual Studio** .</span></span>
...
4.  <span data-ttu-id="1d2bb-361">A continuación, agregue las siguientes variables dentro de la clase *VoiceRecognizer* , sobre el método *Start ()* :</span><span class="sxs-lookup"><span data-stu-id="1d2bb-361">Then add the following variables inside the *VoiceRecognizer* class, above the *Start()* method:</span></span>
...
1.  <span data-ttu-id="1d2bb-371">Haga clic con el botón derecho en la carpeta **scripts** y luego haga clic en **crear**  >  **\# script de C** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-371">Right-click inside the **Scripts** folder, then click **Create** > **C\# Script** .</span></span> <span data-ttu-id="1d2bb-372">Llame al script *CustomVisionTrainer* .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-372">Call the script *CustomVisionTrainer* .</span></span>
...
13. <span data-ttu-id="1d2bb-405">El último método que se va a agregar en esta clase es el método **GetImageAsByteArray ()** , que se utiliza en las llamadas web para convertir la imagen capturada en una matriz de bytes.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-405">The last method to add in this class is the **GetImageAsByteArray()** method, used on the web calls to convert the image captured into a byte array.</span></span>
...
14. <span data-ttu-id="1d2bb-406">Asegúrese de guardar los cambios en **Visual Studio** antes de volver a **Unity** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-406">Be sure to save your changes in **Visual Studio** before returning to **Unity** .</span></span>

## <a name="chapter-10---create-the-sceneorganiser-class"></a><span data-ttu-id="1d2bb-407">Capítulo 10: creación de la clase SceneOrganiser</span><span class="sxs-lookup"><span data-stu-id="1d2bb-407">Chapter 10 - Create the SceneOrganiser class</span></span>

<span data-ttu-id="1d2bb-408">Esta clase hará lo siguiente:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-408">This class will:</span></span>

-   <span data-ttu-id="1d2bb-409">Cree un objeto **cursor** para adjuntar a la cámara principal.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-409">Create a **Cursor** object to attach to the Main Camera.</span></span>

-   <span data-ttu-id="1d2bb-410">Cree un objeto de **etiqueta** que aparecerá cuando el servicio reconozca los objetos del mundo real.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-410">Create a **Label** object that will appear when the Service recognizes the real-world objects.</span></span>

-   <span data-ttu-id="1d2bb-411">Configure la cámara principal adjuntando los componentes adecuados.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-411">Set up the Main Camera by attaching the appropriate components to it.</span></span>

-   <span data-ttu-id="1d2bb-412">En el **modo de análisis** , genere las etiquetas en tiempo de ejecución, en el espacio universal adecuado con respecto a la posición de la cámara principal, y muestre los datos recibidos de la Custom Vision Service.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-412">When in **Analysis Mode** , spawn the Labels at runtime, in the appropriate world space relative to the position of the Main Camera, and display the data received from the Custom Vision Service.</span></span>

-   <span data-ttu-id="1d2bb-413">En el **modo de entrenamiento** , cree la interfaz de usuario que mostrará las distintas fases del proceso de entrenamiento.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-413">When in **Training Mode** , spawn the UI that will display the different stages of the training process.</span></span>

<span data-ttu-id="1d2bb-414">Para crear esta clase:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-414">To create this class:</span></span>

1.  <span data-ttu-id="1d2bb-415">Haga clic con el botón derecho en la carpeta **scripts** y luego haga clic en **crear**  >  **\# script de C** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-415">Right-click inside the **Scripts** folder, then click **Create** > **C\# Script** .</span></span> <span data-ttu-id="1d2bb-416">Asigne al script el nombre *SceneOrganiser* .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-416">Name the script *SceneOrganiser* .</span></span>

2.  <span data-ttu-id="1d2bb-417">Haga doble clic en el nuevo script *SceneOrganiser* para abrirlo con **Visual Studio** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-417">Double-click on the new *SceneOrganiser* script to open it with **Visual Studio** .</span></span>

3.  <span data-ttu-id="1d2bb-418">Solo necesitará un espacio de nombres, quite los otros de encima de la clase *SceneOrganiser* :</span><span class="sxs-lookup"><span data-stu-id="1d2bb-418">You will only need one namespace, remove the others from above the *SceneOrganiser* class:</span></span>

    ```csharp
    using UnityEngine;
    ```

4.  <span data-ttu-id="1d2bb-419">A continuación, agregue las siguientes variables dentro de la clase *SceneOrganiser* , sobre el método **Start ()** :</span><span class="sxs-lookup"><span data-stu-id="1d2bb-419">Then add the following variables inside the *SceneOrganiser* class, above the **Start()** method:</span></span>
...
5.  <span data-ttu-id="1d2bb-420">Elimine los métodos **Start ()** y **Update ()** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-420">Delete the **Start()** and **Update()** methods.</span></span>

6.  <span data-ttu-id="1d2bb-421">Justo debajo de las variables, agregue el método **activo ()** , que inicializará la clase y configurará la escena.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-421">Right underneath the variables, add the **Awake()** method, which will initialize the class and set up the scene.</span></span>
...
7.  <span data-ttu-id="1d2bb-422">Ahora, agregue el método **CreateCameraCursor ()** que crea y coloca el cursor de cámara principal y el método **CreateLabel ()** , que crea el objeto de **etiqueta de análisis** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-422">Now add the **CreateCameraCursor()** method that creates and positions the Main Camera cursor, and the **CreateLabel()** method, which creates the **Analysis Label** object.</span></span>
...
8. <span data-ttu-id="1d2bb-423">Agregue el método **SetCameraStatus ()** , que controlará los mensajes destinados a la malla de texto que proporciona el estado de la cámara.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-423">Add the **SetCameraStatus()** method, which will handle messages intended for the text mesh providing the status of the camera.</span></span>
...
9. <span data-ttu-id="1d2bb-424">Agregue los métodos **PlaceAnalysisLabel ()** y **SetTagsToLastLabel ()** , que generarán y mostrarán los datos del Custom Vision Service en la escena.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-424">Add the **PlaceAnalysisLabel()** and **SetTagsToLastLabel()** methods, which will spawn and display the data from the Custom Vision Service into the scene.</span></span>
...
10. <span data-ttu-id="1d2bb-425">Por último, agregue el método **CreateTrainingUI ()** , que generará la interfaz de usuario que muestra las distintas fases del proceso de entrenamiento cuando la aplicación está en modo de entrenamiento.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-425">Lastly, add the **CreateTrainingUI()** method, which will spawn the UI displaying the multiple stages of the training process when the application is in Training Mode.</span></span> <span data-ttu-id="1d2bb-426">Este método también se utilizará para crear el objeto de estado de la cámara.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-426">This method will also be harnessed to create the camera status object.</span></span>
...
11. <span data-ttu-id="1d2bb-427">Asegúrese de guardar los cambios en **Visual Studio** antes de volver a **Unity** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-427">Be sure to save your changes in **Visual Studio** before returning to **Unity** .</span></span>

> [!IMPORTANT]
> <span data-ttu-id="1d2bb-428">Antes de continuar, abra la clase **CustomVisionAnalyser** y, en el método **AnalyseLastImageCaptured ()** , *Quite las marcas de comentario* de las líneas siguientes:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-428">Before you continue, open the **CustomVisionAnalyser** class, and within the **AnalyseLastImageCaptured()** method, *uncomment* the following lines:</span></span>
>
> ```csharp
>   AnalysisObject analysisObject = new AnalysisObject();
>   analysisObject = JsonConvert.DeserializeObject<AnalysisObject>(jsonResponse);
...
## <a name="chapter-11---create-the-imagecapture-class"></a><span data-ttu-id="1d2bb-429">Capítulo 11: creación de la clase ImageCapture</span><span class="sxs-lookup"><span data-stu-id="1d2bb-429">Chapter 11 - Create the ImageCapture class</span></span>

<span data-ttu-id="1d2bb-430">La clase siguiente que va a crear es la clase *ImageCapture* .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-430">The next class you are going to create is the *ImageCapture* class.</span></span>

<span data-ttu-id="1d2bb-431">Esta clase es responsable de:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-431">This class is responsible for:</span></span>

-   <span data-ttu-id="1d2bb-432">Captura de una imagen con la cámara de HoloLens y su almacenamiento en la carpeta de la *aplicación* .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-432">Capturing an image using the HoloLens camera and storing it in the *App* Folder.</span></span>

-   <span data-ttu-id="1d2bb-433">Controlar los gestos de TAP del usuario.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-433">Handling Tap gestures from the user.</span></span>

-   <span data-ttu-id="1d2bb-434">Mantener el valor de *enumeración* que determina si la aplicación se ejecutará en modo de *análisis* o en modo de *entrenamiento* .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-434">Maintaining the *Enum* value that determines if the application will run in *Analysis* mode or *Training* Mode.</span></span>

<span data-ttu-id="1d2bb-435">Para crear esta clase:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-435">To create this class:</span></span>

1.  <span data-ttu-id="1d2bb-436">Vaya a la carpeta **scripts** que creó anteriormente.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-436">Go to the **Scripts** folder you created previously.</span></span>

2.  <span data-ttu-id="1d2bb-437">Haga clic con el botón derecho en la carpeta y, a continuación, haga clic en **crear > \# script de C** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-437">Right-click inside the folder, then click **Create > C\# Script** .</span></span> <span data-ttu-id="1d2bb-438">Asigne al script el nombre *ImageCapture* .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-438">Name the script *ImageCapture* .</span></span>

3.  <span data-ttu-id="1d2bb-439">Haga doble clic en el nuevo script **ImageCapture** para abrirlo con **Visual Studio** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-439">Double-click on the new **ImageCapture** script to open it with **Visual Studio** .</span></span>

4.  <span data-ttu-id="1d2bb-440">Reemplace los espacios de nombres en la parte superior del archivo por lo siguiente:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-440">Replace the namespaces at the top of the file with the following:</span></span>
...
5.  <span data-ttu-id="1d2bb-441">A continuación, agregue las siguientes variables dentro de la clase *ImageCapture* , sobre el método **Start ()** :</span><span class="sxs-lookup"><span data-stu-id="1d2bb-441">Then add the following variables inside the *ImageCapture* class, above the **Start()** method:</span></span>
...
6.  <span data-ttu-id="1d2bb-442">Ahora es necesario agregar el código para los métodos **activo ()** e **Inicio ()** :</span><span class="sxs-lookup"><span data-stu-id="1d2bb-442">Code for **Awake()** and **Start()** methods now needs to be added:</span></span>
...
7.  <span data-ttu-id="1d2bb-443">Implemente un controlador que se llamará cuando se produzca un gesto de TAP.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-443">Implement a handler that will be called when a Tap gesture occurs.</span></span>
    ...
    > [!NOTE] 
    > <span data-ttu-id="1d2bb-444">En el modo de *análisis* , el método **TapHandler** actúa como un modificador para iniciar o detener el bucle de captura de fotografías.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-444">In *Analysis* mode, the **TapHandler** method acts as a switch to start or stop the photo capture loop.</span></span>
    >
    > <span data-ttu-id="1d2bb-445">En el modo de *entrenamiento* , capturará una imagen de la cámara.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-445">In *Training* mode, it will capture an image from the camera.</span></span>
    >
    > <span data-ttu-id="1d2bb-446">Cuando el cursor está en verde, significa que la cámara está disponible para tomar la imagen.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-446">When the cursor is green, it means the camera is available to take the image.</span></span>
    >
    > <span data-ttu-id="1d2bb-447">Cuando el cursor está en rojo, significa que la cámara está ocupada.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-447">When the cursor is red, it means the camera is busy.</span></span>

8.  <span data-ttu-id="1d2bb-448">Agregue el método que utiliza la aplicación para iniciar el proceso de captura de imagen y almacenar la imagen.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-448">Add the method that the application uses to start the image capture process and store the image.</span></span>
...
9.  <span data-ttu-id="1d2bb-449">Agregue los controladores a los que se llamará cuando se haya capturado la foto y cuando esté listo para su análisis.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-449">Add the handlers that will be called when the photo has been captured and for when it is ready to be analyzed.</span></span> <span data-ttu-id="1d2bb-450">A continuación, el resultado se pasa a *CustomVisionAnalyser* o *CustomVisionTrainer* , en función del modo en el que se establece el código.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-450">The result is then passed to the *CustomVisionAnalyser* or the *CustomVisionTrainer* depending on which mode the code is set on.</span></span>
...
10. <span data-ttu-id="1d2bb-451">Asegúrese de guardar los cambios en **Visual Studio** antes de volver a **Unity** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-451">Be sure to save your changes in **Visual Studio** before returning to **Unity** .</span></span>

11. <span data-ttu-id="1d2bb-452">Ahora que todos los scripts se han completado, vuelva al editor de Unity, haga clic y arrastre la clase **SceneOrganiser** desde la carpeta **scripts** hasta el objeto de **cámara principal** en el *Panel de jerarquías* .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-452">Now that all the scripts have been completed, go back in the Unity Editor, then click and drag the **SceneOrganiser** class from the **Scripts** folder to the **Main Camera** object in the *Hierarchy Panel* .</span></span>

## <a name="chapter-12---before-building"></a><span data-ttu-id="1d2bb-453">Capítulo 12: antes de la compilación</span><span class="sxs-lookup"><span data-stu-id="1d2bb-453">Chapter 12 - Before building</span></span>

<span data-ttu-id="1d2bb-454">Para realizar una prueba exhaustiva de la aplicación, debe transferirla a su HoloLens.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-454">To perform a thorough test of your application you will need to sideload it onto your HoloLens.</span></span>

<span data-ttu-id="1d2bb-455">Antes de hacerlo, asegúrese de que:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-455">Before you do, ensure that:</span></span>

- <span data-ttu-id="1d2bb-456">Toda la configuración mencionada en el [capítulo 2](#chapter-2---training-your-custom-vision-project) se establece correctamente.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-456">All the settings mentioned in the [Chapter 2](#chapter-2---training-your-custom-vision-project) are set correctly.</span></span>

- <span data-ttu-id="1d2bb-457">Todos los campos de la **cámara principal** , el panel Inspector, se asignan correctamente.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-457">All the fields in the **Main Camera** , Inspector Panel, are assigned properly.</span></span>

- <span data-ttu-id="1d2bb-458">El script **SceneOrganiser** se adjunta al objeto de **cámara principal** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-458">The script **SceneOrganiser** is attached to the **Main Camera** object.</span></span>

- <span data-ttu-id="1d2bb-459">Asegúrese de insertar la **clave de predicción** en la variable **predictionKey** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-459">Make sure you insert your **Prediction Key** into the **predictionKey** variable.</span></span>

- <span data-ttu-id="1d2bb-460">Ha insertado el **punto de conexión de predicción** en la variable **predictionEndpoint** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-460">You have inserted your **Prediction Endpoint** into the **predictionEndpoint** variable.</span></span>

- <span data-ttu-id="1d2bb-461">Ha insertado la **clave de entrenamiento** en la variable **trainingKey** de la clase *CustomVisionTrainer* .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-461">You have inserted your **Training Key** into the **trainingKey** variable, of the *CustomVisionTrainer* class.</span></span>

- <span data-ttu-id="1d2bb-462">Ha insertado el **identificador del proyecto** en la variable **Projectid** de la clase *CustomVisionTrainer* .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-462">You have inserted your **Project ID** into the **projectId** variable, of the *CustomVisionTrainer* class.</span></span>

## <a name="chapter-13---build-and-sideload-your-application"></a><span data-ttu-id="1d2bb-463">Capítulo 13: compilar y transferir localmente la aplicación</span><span class="sxs-lookup"><span data-stu-id="1d2bb-463">Chapter 13 - Build and sideload your application</span></span>

<span data-ttu-id="1d2bb-464">Para comenzar el proceso de *compilación* :</span><span class="sxs-lookup"><span data-stu-id="1d2bb-464">To begin the *Build* process:</span></span>

1.  <span data-ttu-id="1d2bb-465">Vaya a **archivo > configuración de compilación** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-465">Go to **File > Build Settings** .</span></span>

2.  <span data-ttu-id="1d2bb-466">Marque **\# proyectos de Unity C** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-466">Tick **Unity C\# Projects** .</span></span>

3.  <span data-ttu-id="1d2bb-467">Haga clic en **Generar** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-467">Click **Build** .</span></span> <span data-ttu-id="1d2bb-468">Unity iniciará una ventana del **Explorador de archivos** , donde tendrá que crear y seleccionar una carpeta en la que compilar la aplicación.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-468">Unity will launch a **File Explorer** window, where you need to create and then select a folder to build the app into.</span></span> <span data-ttu-id="1d2bb-469">Cree esa carpeta ahora y asígnele el nombre **App** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-469">Create that folder now, and name it **App** .</span></span> <span data-ttu-id="1d2bb-470">Después, con la carpeta de la **aplicación** seleccionada, haga clic en **Seleccionar carpeta** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-470">Then with the **App** folder selected, click on **Select Folder** .</span></span>

4.  <span data-ttu-id="1d2bb-471">Unity comenzará a compilar el proyecto en la carpeta de la **aplicación** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-471">Unity will begin building your project to the **App** folder.</span></span>

5.  <span data-ttu-id="1d2bb-472">Una vez que Unity termine de compilar (puede tardar algún tiempo), se abrirá una ventana del **Explorador de archivos** en la ubicación de la compilación (Compruebe la barra de tareas, ya que es posible que no aparezca siempre por encima de las ventanas, pero le notificará la adición de una nueva ventana).</span><span class="sxs-lookup"><span data-stu-id="1d2bb-472">Once Unity has finished building (it might take some time), it will open a **File Explorer** window at the location of your build (check your task bar, as it may not always appear above your windows, but will notify you of the addition of a new window).</span></span>

<span data-ttu-id="1d2bb-473">Para implementar en HoloLens:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-473">To deploy on HoloLens:</span></span>

1.  <span data-ttu-id="1d2bb-474">Necesitará la dirección IP de HoloLens (para la implementación remota) y para asegurarse de que HoloLens está en **modo de desarrollador** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-474">You will need the IP Address of your HoloLens (for Remote Deploy), and to ensure your HoloLens is in **Developer Mode** .</span></span> <span data-ttu-id="1d2bb-475">Para ello, siga estos pasos:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-475">To do this:</span></span>

    1.  <span data-ttu-id="1d2bb-476">Mientras se contenga HoloLens, abra la **configuración** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-476">Whilst wearing your HoloLens, open the **Settings** .</span></span>

    2.  <span data-ttu-id="1d2bb-477">Vaya a **red &**  >  Opciones avanzadas **de Wi-Fi de**  >  **Advanced Options** Internet</span><span class="sxs-lookup"><span data-stu-id="1d2bb-477">Go to **Network & Internet** > **Wi-Fi** > **Advanced Options**</span></span>

    3.  <span data-ttu-id="1d2bb-478">Anote la dirección **IPv4** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-478">Note the **IPv4** address.</span></span>

    4.  <span data-ttu-id="1d2bb-479">A continuación, vuelva a **configuración** y, a continuación, **actualice & Security**  >  **para desarrolladores**</span><span class="sxs-lookup"><span data-stu-id="1d2bb-479">Next, navigate back to **Settings** , and then to **Update & Security** > **For Developers**</span></span>

    5.  <span data-ttu-id="1d2bb-480">Establezca el **modo de Desarrollador en** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-480">Set **Developer Mode On** .</span></span>

2.  <span data-ttu-id="1d2bb-481">Vaya a la nueva compilación de Unity (la carpeta de la **aplicación** ) y abra el archivo de solución con **Visual Studio** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-481">Navigate to your new Unity build (the **App** folder) and open the solution file with **Visual Studio** .</span></span>

3.  <span data-ttu-id="1d2bb-482">En la *configuración de soluciones* , seleccione **depurar** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-482">In the *Solution Configuration* select **Debug** .</span></span>

4.  <span data-ttu-id="1d2bb-483">En la *plataforma* de la solución, seleccione **x86, equipo remoto** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-483">In the *Solution Platform* , select **x86, Remote Machine** .</span></span> <span data-ttu-id="1d2bb-484">Se le pedirá que inserte la **dirección IP** de un dispositivo remoto (HoloLens, en este caso, que anotó).</span><span class="sxs-lookup"><span data-stu-id="1d2bb-484">You will be prompted to insert the **IP address** of a remote device (the HoloLens, in this case, which you noted).</span></span>

    ![Establecer dirección IP](images/AzureLabs-Lab302b-34.png)

5. <span data-ttu-id="1d2bb-486">Vaya al menú **compilar** y haga clic en **implementar solución** para transferir localmente la aplicación a HoloLens.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-486">Go to **Build** menu and click on **Deploy Solution** to sideload the application to your HoloLens.</span></span>

6. <span data-ttu-id="1d2bb-487">La aplicación debe aparecer ahora en la lista de aplicaciones instaladas en HoloLens, lista para su lanzamiento.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-487">Your app should now appear in the list of installed apps on your HoloLens, ready to be launched!</span></span>

> [!NOTE]
> <span data-ttu-id="1d2bb-488">Para implementar en auriculares inmersivo, establezca la **plataforma** de la solución en el *equipo local* y establezca la **configuración** en *depurar* , con *x86* como **plataforma** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-488">To deploy to immersive headset, set the **Solution Platform** to *Local Machine* , and set the **Configuration** to *Debug* , with *x86* as the **Platform** .</span></span> <span data-ttu-id="1d2bb-489">A continuación, implemente en el equipo local mediante el elemento de menú **compilar** y seleccione *implementar solución* .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-489">Then deploy to the local machine, using the **Build** menu item, selecting *Deploy Solution* .</span></span> 

## <a name="to-use-the-application"></a><span data-ttu-id="1d2bb-490">Para usar la aplicación:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-490">To use the application:</span></span>

<span data-ttu-id="1d2bb-491">Para cambiar la funcionalidad de la aplicación entre el modo de *entrenamiento* y el modo de *predicción* , debe actualizar la variable **AppMode** , ubicada en el método **activo ()** ubicado dentro de la clase *ImageCapture* .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-491">To switch the app functionality between *Training* mode and *Prediction* mode you need to update the **AppMode** variable, located in the **Awake()** method located within the *ImageCapture* class.</span></span>

```
        // Change this flag to switch between Analysis mode and Training mode 
        AppMode = AppModes.Training;
```
<span data-ttu-id="1d2bb-492">or</span><span class="sxs-lookup"><span data-stu-id="1d2bb-492">or</span></span>
```
        // Change this flag to switch between Analysis mode and Training mode 
        AppMode = AppModes.Analysis;
```

<span data-ttu-id="1d2bb-493">En modo de *entrenamiento* :</span><span class="sxs-lookup"><span data-stu-id="1d2bb-493">In *Training* mode:</span></span>

- <span data-ttu-id="1d2bb-494">Fíjese en **mouse** o **teclado** y use el **gesto de puntear** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-494">Look at **Mouse** or **Keyboard** and use the **Tap gesture** .</span></span>

- <span data-ttu-id="1d2bb-495">A continuación, aparecerá texto en el que se le pedirá que proporcione una etiqueta.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-495">Next, text will appear asking you to provide a tag.</span></span>

- <span data-ttu-id="1d2bb-496">Por ejemplo, el **mouse** o el **teclado** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-496">Say either **Mouse** or **Keyboard** .</span></span>


<span data-ttu-id="1d2bb-497">En modo de *predicción* :</span><span class="sxs-lookup"><span data-stu-id="1d2bb-497">In *Prediction* mode:</span></span>

- <span data-ttu-id="1d2bb-498">Mire un objeto y use el **gesto de puntear** .</span><span class="sxs-lookup"><span data-stu-id="1d2bb-498">Look at an object and use the **Tap gesture** .</span></span>

- <span data-ttu-id="1d2bb-499">Aparecerá el texto proporcionando el objeto detectado, con la probabilidad más alta (se normaliza).</span><span class="sxs-lookup"><span data-stu-id="1d2bb-499">Text will appear providing the object detected, with the highest probability (this is normalized).</span></span>

## <a name="chapter-14---evaluate-and-improve-your-custom-vision-model"></a><span data-ttu-id="1d2bb-500">Capítulo 14: evaluación y mejora del modelo de Custom Vision</span><span class="sxs-lookup"><span data-stu-id="1d2bb-500">Chapter 14 - Evaluate and improve your Custom Vision model</span></span>

<span data-ttu-id="1d2bb-501">Para que el servicio sea más preciso, debe seguir entrenar el modelo usado para la predicción.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-501">To make your Service more accurate, you will need to continue to train the model used for prediction.</span></span> <span data-ttu-id="1d2bb-502">Esto se logra mediante el uso de la nueva aplicación, con los modos de *entrenamiento* y *predicción* , con los que se necesitan para visitar el portal, que es lo que se trata en este capítulo.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-502">This is accomplished through using your new application, with both the *training* and *prediction* modes, with the latter requiring you to visit the portal, which is what is covered in this Chapter.</span></span> <span data-ttu-id="1d2bb-503">Esté preparado para volver a visitar su portal muchas veces, para mejorar continuamente el modelo.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-503">Be prepared to revisit your portal many times, to continually improve your model.</span></span>

1. <span data-ttu-id="1d2bb-504">Vuelva al portal de Azure Custom Vision y, una vez que esté en el proyecto, seleccione la pestaña *predicciones* (en el centro superior de la página):</span><span class="sxs-lookup"><span data-stu-id="1d2bb-504">Head to your Azure Custom Vision Portal again, and once you are in your project, select the *Predictions* tab (from the top center of the page):</span></span>

    ![Seleccionar la pestaña predicciones](images/AzureLabs-Lab302b-35.png)

2. <span data-ttu-id="1d2bb-506">Verá todas las imágenes que se enviaron al servicio mientras se ejecutaba la aplicación.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-506">You will see all the images which were sent to your Service whilst your application was running.</span></span> <span data-ttu-id="1d2bb-507">Si mantiene el mouse sobre las imágenes, le proporcionará las predicciones que se realizaron para esa imagen:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-507">If you hover over the images, they will provide you with the predictions that were made for that image:</span></span>

    ![Lista de imágenes de predicción](images/AzureLabs-Lab302b-36.png)

3. <span data-ttu-id="1d2bb-509">Seleccione una de las imágenes para abrirla.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-509">Select one of your images to open it.</span></span> <span data-ttu-id="1d2bb-510">Una vez abierta, verá las predicciones realizadas para esa imagen a la derecha.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-510">Once open, you will see the predictions made for that image to the right.</span></span> <span data-ttu-id="1d2bb-511">Si las predicciones son correctas y desea agregar esta imagen al modelo de entrenamiento del servicio, haga clic en el cuadro de entrada *mis etiquetas* y seleccione la etiqueta que desea asociar.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-511">If you the predictions were correct, and you wish to add this image to your Service's training model, click the *My Tags* input box, and select the tag you wish to associate.</span></span> <span data-ttu-id="1d2bb-512">Cuando haya terminado, haga clic en el botón *Guardar y cerrar* situado en la parte inferior derecha y continúe con la imagen siguiente.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-512">When you are finished, click the *Save and close* button to the bottom right, and continue on to the next image.</span></span>

    ![Seleccionar la imagen que se va a abrir](images/AzureLabs-Lab302b-37.png)

4. <span data-ttu-id="1d2bb-514">Una vez que vuelva a la cuadrícula de imágenes, observará que se quitarán las imágenes que haya agregado etiquetas (y guardado).</span><span class="sxs-lookup"><span data-stu-id="1d2bb-514">Once you are back to the grid of images, you will notice the images which you have added tags to (and saved), will be removed.</span></span> <span data-ttu-id="1d2bb-515">Si encuentra alguna imagen que cree que no tiene el elemento etiquetado, puede eliminarlas haciendo clic en la marca de la imagen (puede hacer esto para varias imágenes) y, a continuación, hacer clic en *eliminar* en la esquina superior derecha de la página de cuadrícula.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-515">If you find any images which you think do not have your tagged item within them, you can delete them, by clicking the tick on that image (can do this for several images) and then clicking *Delete* in the upper right corner of the grid page.</span></span> <span data-ttu-id="1d2bb-516">En el menú emergente que aparece a continuación, puede hacer clic en *sí, eliminar* o *no* , para confirmar la eliminación o cancelarla, respectivamente.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-516">On the popup that follows, you can click either *Yes, delete* or *No* , to confirm the deletion or cancel it, respectively.</span></span> 

    ![Eliminación de imágenes](images/AzureLabs-Lab302b-38.png)

5. <span data-ttu-id="1d2bb-518">Cuando esté listo para continuar, haga clic en el botón verde *entrenar* situado en la parte superior derecha.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-518">When you are ready to proceed, click the green *Train* button in the top right.</span></span> <span data-ttu-id="1d2bb-519">El modelo de servicio se entrenará con todas las imágenes que ya ha proporcionado (lo que hará que sea más preciso).</span><span class="sxs-lookup"><span data-stu-id="1d2bb-519">Your Service model will be trained with all the images which you have now provided (which will make it more accurate).</span></span> <span data-ttu-id="1d2bb-520">Una vez completado el entrenamiento, asegúrese de hacer clic en el botón *establecer como predeterminado* una vez más para que la *dirección URL de predicción* siga usando la iteración más actualizada del servicio.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-520">Once the training is complete, make sure to click the *Make default* button once more, so that your *Prediction URL* continues to use the most up-to-date iteration of your Service.</span></span>

    <span data-ttu-id="1d2bb-521">![Iniciar el modelo de servicio de entrenamiento ](images/AzureLabs-Lab302b-39.png) ![ seleccionar la opción establecer como predeterminada](images/AzureLabs-Lab302b-40.png)</span><span class="sxs-lookup"><span data-stu-id="1d2bb-521">![Start training service model](images/AzureLabs-Lab302b-39.png) ![Select make default option](images/AzureLabs-Lab302b-40.png)</span></span>

## <a name="your-finished-custom-vision-api-application"></a><span data-ttu-id="1d2bb-522">Su aplicación de API de Custom Vision finalizada</span><span class="sxs-lookup"><span data-stu-id="1d2bb-522">Your finished Custom Vision API application</span></span>

<span data-ttu-id="1d2bb-523">Enhorabuena, ha creado una aplicación de realidad mixta que aprovecha Azure Custom Vision API para reconocer objetos reales, entrenar el modelo de servicio y mostrar la confianza de lo que se ha detectado.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-523">Congratulations, you built a mixed reality app that leverages the Azure Custom Vision API to recognize real world objects, train the Service model, and display confidence of what has been seen.</span></span>

![Ejemplo de proyecto terminado](images/AzureLabs-Lab302b-00.png)

## <a name="bonus-exercises"></a><span data-ttu-id="1d2bb-525">Ejercicios extra</span><span class="sxs-lookup"><span data-stu-id="1d2bb-525">Bonus exercises</span></span>

### <a name="exercise-1"></a><span data-ttu-id="1d2bb-526">Ejercicio 1</span><span class="sxs-lookup"><span data-stu-id="1d2bb-526">Exercise 1</span></span>

<span data-ttu-id="1d2bb-527">Entrenar el **Custom Vision Service** para reconocer más objetos.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-527">Train your **Custom Vision Service** to recognize more objects.</span></span>

### <a name="exercise-2"></a><span data-ttu-id="1d2bb-528">Ejercicio 2</span><span class="sxs-lookup"><span data-stu-id="1d2bb-528">Exercise 2</span></span>

<span data-ttu-id="1d2bb-529">Para ampliar la información que ha aprendido, complete los siguientes ejercicios:</span><span class="sxs-lookup"><span data-stu-id="1d2bb-529">As a way to expand on what you have learned, complete the following exercises:</span></span>

<span data-ttu-id="1d2bb-530">Reproducir un sonido cuando se reconoce un objeto.</span><span class="sxs-lookup"><span data-stu-id="1d2bb-530">Play a sound when an object is recognized.</span></span>

### <a name="exercise-3"></a><span data-ttu-id="1d2bb-531">Ejercicio 3</span><span class="sxs-lookup"><span data-stu-id="1d2bb-531">Exercise 3</span></span>

<span data-ttu-id="1d2bb-532">Use la API para volver a entrenar su servicio con las mismas imágenes que está analizando la aplicación, para que el servicio sea más preciso (realice la predicción y el entrenamiento simultáneamente).</span><span class="sxs-lookup"><span data-stu-id="1d2bb-532">Use the API to re-train your Service with the same images your app is analyzing, so to make the Service more accurate (do both prediction and training simultaneously).</span></span>
