...
4.  A continuación, vaya a configuración de compilación de ***archivos* *Build Settings*** y cambie la plataforma a **plataforma universal de Windows** , haciendo clic en el botón **cambiar plataforma** .
