...
Puede tener acceso al [gesto y al controlador de movimiento](https://docs.microsoft.com/windows/mixed-reality/mrtk-unity/features/input/controllers) desde el administrador de entrada.
