...
La comprensión de la escena Mixed Reality a los desarrolladores con una representación de entorno estructurada y de alto nivel diseñada para que el desarrollo para aplicaciones que tienen en cuenta el entorno sea intuitivo. La comprensión de la escena lo hace combinando la potencia de los [](spatial-mapping.md) entornos de ejecución de realidad mixta existentes, como la asignación espacial altamente precisa pero menos estructurada y los nuevos entornos de ejecución controlados por inteligencia artificial. Mediante la combinación de estas tecnologías, scene understanding genera representaciones de entornos 3D similares a los que puede haber usado en marcos como Unity o ARKit/ARCore. El punto de entrada scene understanding comienza con un observador de escena, al que llama la aplicación para calcular una nueva escena. En la actualidad, la tecnología puede generar tres categorías de objetos distintas pero relacionadas:

* Mallas de entorno herméticas simplificadas que deducen la estructura plana de la sala sin desorden
...
Este artículo solo sirve para presentar el entorno de ejecución y los conceptos de Scene Understanding. Si busca documentación sobre cómo desarrollar con Scene Understanding, puede que le interesen los siguientes artículos:
