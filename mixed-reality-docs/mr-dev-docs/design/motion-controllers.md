...
* Visite [instalar las herramientas](../develop/install-the-tools.md) para las versiones preferidas de Windows, Unity, etc. para el desarrollo de la realidad mixta.
