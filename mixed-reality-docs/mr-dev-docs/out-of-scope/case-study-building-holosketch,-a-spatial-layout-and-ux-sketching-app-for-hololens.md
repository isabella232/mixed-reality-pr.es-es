---
title: 'Caso práctico: creación de HoloTch, un diseño espacial y una aplicación de boceto de experiencia de usuario para HoloLens'
...
ms.date: 03/21/2018
ms.topic: article
keywords: HoloTch, HoloLens, Windows Mixed Reality, boceto, aplicación
ms.openlocfilehash: 24929d38f97a3c02946a28184d7702c151dc22b2
ms.sourcegitcommit: 9831b89a1641ba1b5df14419ee2a4f29d3fa2d64
ms.translationtype: MT
ms.contentlocale: es-ES
ms.lasthandoff: 07/29/2021
ms.locfileid: "114757327"
---
# <a name="case-study---building-holosketch-a-spatial-layout-and-ux-sketching-app-for-hololens"></a>Caso práctico: creación de HoloTch, un diseño espacial y una aplicación de boceto de experiencia de usuario para HoloLens

Holo Holo HoloTch es una herramienta de diseño espacial en el dispositivo y de dibujo de la experiencia de usuario HoloLens para ayudar a crear experiencias holográficas. HoloTch funciona con un teclado Bluetooth mouse, así como comandos de gesto y voz. El propósito de HoloTch es proporcionar una sencilla herramienta de diseño de experiencia de usuario para una visualización e iteración rápidas.

![Holo HoloTch: una aplicación de diseño espacial y de boceto de experiencia de usuario para HoloLens.](images/holosketch-image-01-640px.png)<br>
*HoloTch: diseño espacial y aplicación de boceto de experiencia de usuario para HoloLens*

![Una sencilla herramienta de diseño de experiencia de usuario para una visualización e iteración rápidas.](images/holosketch-image-02.png)<br>
*Una sencilla herramienta de diseño de experiencia de usuario para una visualización e iteración rápidas*
...
Manipular objetos (mover, girar o escalar) con una interfaz de objetos 3D conocida.
...
HoloTch admite Bluetooth mouse/teclado, gestos y comandos de voz.
...
Para comunicar eficazmente flujos y escenarios de experiencia de usuario a otros usuarios, un diseñador puede acabar dedicando mucho tiempo a crear recursos mediante herramientas 2D tradicionales, como Designer, Photoshop y PowerPoint. Estos diseños 2D a menudo requieren un esfuerzo adicional para convertirlos en 3D. Algunas ideas se pierden en esta traducción de 2D a 3D.

### <a name="complex-deployment-process"></a>Proceso de implementación complejo

Puesto que la realidad mixta es un nuevo lienzo para nosotros, implica una gran cantidad de iteración de diseño y prueba y error por su naturaleza. Para los diseñadores que no están familiarizados con herramientas como Unity y Visual Studio, no es fácil reunir algo en HoloLens. Normalmente, tiene que seguir el proceso siguiente para ver las ilustraciones 2D/3D en el dispositivo. Se trata de una gran barrera para los diseñadores que iteran en ideas y escenarios rápidamente.

![Proceso de implementación complejo](images/holosketch-image-03-1000px.png)<br>
*Proceso de implementación*

### <a name="simplified-process-with-holosketch"></a>Proceso simplificado con HoloTch

Con Holo HoloTch, queríamos simplificar este proceso sin implicar herramientas de desarrollo y emparejamiento del portal de dispositivos. Con OneDrive, los usuarios pueden colocar fácilmente recursos 2D/3D en HoloLens.

![Proceso simplificado con HoloTch](images/holosketch-image-04-1000px.png)<br>
*Proceso simplificado con HoloTch*

### <a name="encouraging-three-dimensional-design-thinking-and-solutions"></a>Fomentar soluciones y pensar en el diseño tridimensional

Creemos que esta herramienta ofrecería a los diseñadores la oportunidad de explorar soluciones en un espacio realmente tridimensional y no quedarse bloqueado en 2D. No tienen que pensar en crear un fondo 3D para su interfaz de usuario, ya que el fondo es el mundo real en el caso de HoloLens. HoloTch abre una manera para que los diseñadores exploren fácilmente el diseño 3D en HoloLens.

## <a name="get-started"></a>Introducción

### <a name="how-to-import-2d-images-jpgpng-into-holosketch"></a>Importación de imágenes 2D (JPG/PNG) en HoloTch

* Upload Imágenes JPG/PNG en la carpeta OneDrive "Documents/HoloTch".
* En el OneDrive de HoloTch, podrá seleccionar y colocar la imagen en el entorno.

![Importación de imágenes 2D](images/import-2d-images-1000px.jpg)<br>
*Importación de imágenes y objetos 3D mediante OneDrive*

### <a name="how-to-import-3d-objects-into-holosketch"></a>Importación de objetos 3D en HoloTch

Antes de cargar en la OneDrive, siga los pasos que se indican a continuación para empaquetar los objetos 3D en un conjunto de recursos de Unity. Con este proceso puede importar los archivos FBX/OBJ desde software 3D como Maya, Maya 4D y Microsoft Paint 3D.
...
10. Prepare una imagen en miniatura para el objeto de modelo. 
   ![Arrastre una imagen al panel del proyecto y asigne el nombre que se usa para el objeto.](images/holosketch-15-assetbundles-1000px.png)
...
13. **Upload el archivo generado en la carpeta /Files/Documents/HoloTch de OneDrive.** Upload el asset_unique_name archivo. No es necesario cargar archivos de manifiesto ni archivos AssetBundles. <br>
![Agregar archivos a la carpeta Files/Documents/HoloTch/ Verá que se ha agregado un objeto 3D en el menú de OneDrive ](images/holosketch-onedriveupload-1000px.png)
 ![ HoloTch.](images/holosketch-14-onedriveexample-1000px.jpg)

## <a name="how-to-manipulate-the-objects"></a>Cómo manipular los objetos

HoloTch admite la interfaz tradicional que se usa ampliamente en software 3D. Puede usar mover, girar y escalar los objetos con gestos y un mouse. Puede cambiar rápidamente entre diferentes modos con voz o teclado.
...
### <a name="contextual-and-tool-belt-menus"></a>Menús contextuales y de cinta de herramientas

**Uso del menú contextual**

Pulse dos veces el aire para abrir el menú contextual. 
...
* **Primitivas:** Use cubos, esferas, cilindros y conos para los estudios de masa.
...
Move, Rotate, Scale, Save y Load Scene están disponibles en el menú De la cinta de herramientas. 
...
* Actualmente, se admite la creación de paquetes **de recursos con la versión 5.4.5f1 de Unity.**
* Dependiendo de la cantidad de datos del OneDrive, la aplicación podría aparecer como si se hubiera detenido al cargar OneDrive contenido.
