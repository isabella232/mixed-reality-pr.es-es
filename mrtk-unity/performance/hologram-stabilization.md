...
1. En **Edit**  >  **Project Configuración**  >  **Player**  >  **XR Configuración** Virtual  >  **Reality SDKs** > Enable Depth Buffer **Sharing**
...
En Text Mesh Pro objetos, seleccione el objeto GameObject de TMP para verlo en el inspector. En el componente de material, cambie el sombreador del material asignado para usar el sombreador TextMeshPro de MRTK.

![Corrección del búfer Pro profundidad de Text Mesh](../features/images/performance/TextMeshPro-DepthBuffer-Fix.PNG)
