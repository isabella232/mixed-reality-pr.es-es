...
1. No use capturas de pantalla para las cosas que se pueden describir en texto. Especialmente, **nunca captura de pantalla una cuadrícula de propiedades** con el único fin de mostrar los nombres de propiedad y los valores.
...
1. Haga que alguien lea a prueba la página para el estilo y el formato. Puede ser alguien que no esté familiarizado con el tema, que también es una buena idea para obtener comentarios sobre lo comprensible que es la documentación.
...
Si hay dependencias de nivel de clase, se deben documentar en un bloque de comentarios, inmediatamente debajo del resumen.
...
## <a name="how-to-documentation"></a>Documentación de cómo hacerlo
