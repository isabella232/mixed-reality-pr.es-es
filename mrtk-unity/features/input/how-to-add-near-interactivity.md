...
Las interacciones cercanas se forman en forma de toques y agarrar. Los eventos de entrada táctil y de captura se elevan como eventos de puntero por [Parte de NoéPointer](pointers.md#pokepointer) y [SpherePointer,](pointers.md#spherepointer)respectivamente.
...
1. En el Elemento GameObject que se debe poder agarrar, agregue un elemento , así [`NearInteractionGrabbable`](xref:Microsoft.MixedReality.Toolkit.Input.NearInteractionGrabbable) como un colisionador.
...
La primera forma suele ser en objetos con BoxColliders, donde solo se desea que una sola cara del colisionador reaccione a eventos táctiles. El otro es para los objetos que deben ser táctiles desde cualquier dirección en función de su colisionador.
